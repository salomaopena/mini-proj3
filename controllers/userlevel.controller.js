...
exports.get = (req, res) => {
    ...
    UserLeveL.find(req.query, (error, levels) => {
        ...
        var message = UserLevelMessages.success.s2;
...
exports.getOne = (req, res) => {
    ...
    UserLeveL.findOne({
        ...
        const message = UserLevelMessages.success.s2;
...
exports.create = (req, res) => {
    ...
    new UserLeveL({
        ...
        const message = UserLevelMessages.success.s0;
        message.body = user_level;
...
exports.update = (req, res) => {
    ...
    UserLeveL.findOneAndUpdate({
        ...
        if (error) console.log('Ops! Ocorreu um erro' + error)
        if (!user_level) return res.status(UserLevelMessages.error.e0.http).send(UserLevelMessages.error.e0)
        const message = UserLevelMessages.success.s1;
        message.body = user_level;
        return res.status(message.http).send(message);
